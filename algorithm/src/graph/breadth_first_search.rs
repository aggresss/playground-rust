...
mod tests {
    ...
    fn graph1() -> Graph {
        ...
        Graph::new(
            ...
            edges.into_iter().map(|v| v.into()).collect(),
        )
    }
    ...
    #[test]
    fn breadth_first_search_graph1_when_8_should_evaluate_all_nodes_first() {
        let graph = graph1();
        let root = 1;
        let target = 8;
    ...
    fn breadth_first_search_graph2_when_no_path_to_node_returns_none() {
        ...
        assert_eq!(breadth_first_search(&graph, root.into(), target.into()), None);
    }
    ...
    fn breadth_first_search_graph2_should_find_path_from_4_to_1() {
        ...
        assert_eq!(breadth_first_search(&graph, root.into(), target.into()), Some(expected_path));
    }
}
